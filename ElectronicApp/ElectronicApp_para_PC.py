...
<Pantalla2@Screen>:
    canvas.before:
        Color:
            rgba: utils.get_color_from_hex("#33CC66")
        Rectangle:
            pos: self.pos
            size: self.size
        Color:
...
<WelcomeScreen>:
    ...
    Pantalla:
        MDCard:
            ...
            New:
                text: "Prueba tus conocimientos"  # Nuevo botón para acceder al quiz
                font_size: 20
                pos_hint: {"center_x": 0.5}
                on_release: app.root.current = 'menu'  # Cambia a la pantalla de menú
...
<NotesScreen>:
    ...
    Pantalla:
        MDCard:
            ...
            BoxLayout:
                id: notes_label  # Cambiar a BoxLayout para contener las notas y botones
                orientation: 'vertical'
                size_hint_y: None
...
<ComponentsScreen>:
    ...
    Pantalla:
        MDCard:
            ...
            MDLabel:
                text: "1. Resistor: Limita la corriente en un circuito."
                halign: 'left'
                theme_text_color: "Custom"
                text_color: utils.get_color_from_hex("#000000")

            MDLabel:
                text: "2. Capacitor: Almacena energía en un campo eléctrico."
                halign: 'left'
                theme_text_color: "Custom"
                text_color: utils.get_color_from_hex("#000000")

            MDLabel:
                text: "3. Diodo: Permite el flujo de corriente en una sola dirección."
                halign: 'left'
                theme_text_color: "Custom"
                text_color: utils.get_color_from_hex("#000000")

            MDLabel:
                text: "4. Transistor: Actúa como interruptor o amplificador."
                halign: 'left'
                theme_text_color: "Custom"
                text_color: utils.get_color_from_hex("#000000")

            MDLabel:
                text: "5. LED: Emite luz al pasar corriente."
                halign: 'left'
                theme_text_color: "Custom"
                text_color: utils.get_color_from_hex("#000000")

            MDLabel:
                text: "6. Circuito Integrado: Conjunto de circuitos en un chip."
                halign: 'left'
                theme_text_color: "Custom"
                text_color: utils.get_color_from_hex("#000000")

            MDLabel:
                text: "7. Sensor de Temperatura: Mide la temperatura."
                halign: 'left'
                theme_text_color: "Custom"
                text_color: utils.get_color_from_hex("#000000")

            MDLabel:
                text: "8. Relé: Interruptor controlado eléctricamente."
                halign: 'left'
                theme_text_color: "Custom"
                text_color: utils.get_color_from_hex("#000000")

            MDLabel:
                text: "9. Motor DC: Convierte energía eléctrica en mecánica."
                halign: 'left'
                theme_text_color: "Custom"
                text_color: utils.get_color_from_hex("#000000")

            MDLabel:
                text: "10. Batería: Almacena energía química."
                halign: 'left'
                theme_text_color: "Custom"
                text_color: utils.get_color_from_hex("#000000")
...
<ElectroWikiScreen>:
    ...
    canvas.before:
        Color:
            rgba: utils.get_color_from_hex("#111111")  # Color de fondo deseado
        Rectangle:
            pos: self.pos
            size: self.size
    ScrollView:
...
<DificultadScreen>:
    ...
    MDBoxLayout:
        ...
        canvas.before:
            Color:
                rgba: 0.5, 0.5, 0.5, 1  # Color azul oscuro (RGBA)
            Rectangle:
                pos: self.pos
                size: self.size
        MDLabel:
